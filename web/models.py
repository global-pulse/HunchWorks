...
class Users(models.Model):
    ...
    first_name = models.CharField(
    	max_length=60, db_column='firstName')
    last_name = models.CharField(
    	max_length=150, db_column='lastName')
    ...
    invited_by = models.CharField(
    	max_length=3000, db_column='invitedBy', blank=True)
    has_invited = models.CharField(
    	max_length=3000, db_column='hasInvited', blank=True)
    ...
    languages_known = models.CharField(
    	max_length=600, db_column='languagesKnown', blank=True)
    ...
    privacy = models.CharField(
    	max_length=18, default='Hidden', choices=PRIVACY_CHOICES)
    preferred_language = models.CharField(
    	max_length=90, db_column='preferredLanguage', choices=LANGUAGE_CHOICES)
    workphone = models.CharField(
    	max_length=90, blank=True)
    location_interests = models.CharField(
    	max_length=600, db_column='locationInterests', blank=True)
    organization = models.CharField(
    	max_length=150, blank=True)
    bio_text = models.CharField(
    	max_length=3000, db_column='bioText', blank=True)
    work_history = models.CharField(
    	max_length=3000, db_column='workHistory', blank=True)
    skype_name = models.CharField(
    	max_length=90, db_column='skypeName', blank=True)
    instant_messanger = models.CharField(
    	max_length=90, db_column='instantMessanger', blank=True)
    	#TODO(Texas:6-15-11) Add instant messanger option list when created
    website = models.CharField(
    	max_length=300, blank=True)
    profile_picture_location = models.CharField(
    	max_length=300, db_column='profilePictureLocation', blank=True)
    blocked_users = models.CharField(
    	max_length=3000, db_column='blockedUsers', blank=True)
...
class Hunch(models.Model):
    ...
    hunch_confirmed = models.CharField(
    	max_length=27, db_column='hunchConfirmed', default='Undetermined', 
    ...
    invited_users = models.CharField(
    	max_length=3000, db_column='invitedUsers', blank=True) 
    invited_groups = models.CharField(
    	max_length=3000, db_column='invitedGroups', blank=True) 
    additional_invites = models.CharField(
    	max_length=3000, db_column='additionalInvites', blank=True) 
    language = models.CharField(
    	max_length=90, default='English', choices=LANGUAGE_CHOICES)
    location = models.CharField(
    	max_length=300, blank=True)
...
class Evidence(models.Model):
    ...
    attachment_ids = models.CharField(
    	max_length=3000, db_column='attachmentIds', blank=True) 
    language = models.CharField(
    	max_length=90, blank=True)
    	#TODO(Texas:6-15-11) Add language list in the future
...
class Attachments(models.Model):
    ...
    file_location = models.CharField(
    	max_length=300, db_column='fileLocation') 
...
class Groups(models.Model):
    ...
    group_type = models.CharField(
    	max_length=30, db_column='groupType', choices=GROUP_CHOICES) 
    privacy = models.CharField(
    	max_length=18, default='Hidden', choices=PRIVACY_CHOICES)
    location = models.CharField(
    	max_length=300, blank=True)
    picture_location = models.CharField(
    	max_length=300, db_column='pictureLocation', blank=True) 
...
class GroupMembership(models.Model):
    ...
    access_level = models.CharField(
    	max_length=18, db_column='accessLevel', default='Member', 
